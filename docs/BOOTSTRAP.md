...
Containers com `network_mode: host` (postgres_tailnet_proxy) não mostram mapeamento de portas — escutam direto na interface `tailscale0` do host.
...
### 9.3 — Tailnet (Postgres via socat)
